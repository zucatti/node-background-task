...
exports.initialize = function(options, callback) {
  ...
  NotificationBus = function(options, callback){
    ...
    // Handle error events
    this.dataClient.on('taskError', function(evt){utils.wrapError(evt);});
    this.pubClient.on('taskError', function(evt){utils.wrapError(evt);});
    this.subClient.on('taskError', function(evt){utils.wrapError(evt);});
  };
